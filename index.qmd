...
1.  Notes on the theory and application of agent-based modeling to promoting the
   social diffusion of sustainable practices through social learning and social
   influence. Continue on to the [Introduction](intro.qmd) to read the Notes.
