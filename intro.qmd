...
[@Nalau2018;@Pearson2020;@McNamara2020]. 
...
The cognitive and social factors we
identify are suitable for inclusion in _agent-based models_ of social behavior
that we use to deduce the emergent social outcomes we can expect from different
strategies for social interventions to promote sustainable practices.
An agent-based model is a general type of model where people are represented as
autonomous _agents_ who perform behaviors or processes based on their own
localized, adaptive decisionmaking. In our models of social behavior, these
agents learn from one another or influence one another's opinion, and use this
information to make decisions about which behavior they should do. 
...
population. We will analyze and draw on several real-world empirical studies of
interventions to develop our agent-based models that we in turn will use to
develop models of interventions in order to deduce which intervention
strategies are most effective and why in idealized, cost-free settings
(cost-free at least compared to the cost of real-world social interventions at
scale). 

The [UN Sustainable Development Goals](https://sdgs.un.org/) help us focus and
organize our work by providing concrete goals for evaluating progress 
towards sustainable development for all. These goals include targets for
institutional development that promotes justice and equality; 
basic human survival and thriving necessary for people to care and pursue ecological
protections; and climate action and ecological protections themselves. 
Unfortunately, progress has been slower than necessary. Recent analyses of
progress suggests accelerated transformations
are required to reach goals necessary to avoid increasingly frequent and costly
climate change disasters [@UnitedNations2023]. Unless things
...
the _Environment_. All 17 goals and the organization system are illustrated in
Figure X. Organizing and connecting our work to  has two benefits. First, it helps us identify which cognitive and social factors are at work in different sustainability foci.
Second, it expands the corpus of existing research on which we draw to
consolidate our social and cognitive theories of behavior change that we will
apply to sustainability interventions. 

In the rest of this introductory chapter we expand on the real-world examples
given above of sustainable adaptations by formally identifying, categorizing,
and representing different social and cognitive processes at work when people
learn from, observe, and teach one another, and integrate that with their own
personal experience.  The urgent need to understand how sustainable behaviors
spread in order to develop effective interventions forces us social scientists
to radically rethink how we conceptualize social change to make it rigorous,
reliable, and digestible by non-social scientists.


## Social and cognitive factors in agent-based models of sustainable adaptation
